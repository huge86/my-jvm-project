 ...
 *
 */
public class OssAppDemo {
    private static final Logger logger = LoggerFactory.getLogger(OssAppDemo.class);
    //static Logger logger = Logger.getLogger(OssAppDemo.class);//log4j的用法，jar包需要放到WEB-INF-lib目录下
    ...
    private static String accessKeySecret = "jmS3LugyrNU9ARhPZBbmQ0j8XP27e1";
